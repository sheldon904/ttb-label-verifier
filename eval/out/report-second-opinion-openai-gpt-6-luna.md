...
| p50 | p95 | p99 | max |
|---|---|---|---|
| 954 ms | 4794 ms | 5394 ms | 7047 ms |

Interactive target is < 5 000 ms. **p95 MET.**

Throughput: **36 labels/min** (52 in 85.7s). A 300-label batch would take about **8.2 minutes** at this concurrency.
...
| `clean_03` | pass | pass | 976 | Compliant label, Copper Ridge Reserve |
| `net_contents_centilitres` | flag | flag | 954 | '75 cl' alone against '750 mL': the same volume, but 27 CFR 5.70(a) asks for liters or milliliters, so it is referred |
| `net_contents_missing` | fail | fail | 913 | Net contents absent from the artwork |
| `net_contents_wrong` | fail | fail | 950 | 700 mL on the label, 750 mL on the application |
...
| `v2_malt_floz` | pass | pass | 981 | Second template: '12 FL OZ' on the label, '355 mL' on the application |
| `v2_malt_floz_wrong` | fail | fail | 880 | Second template: '16 FL OZ' on the label, '355 mL' on the application |
| `v2_photo_skewed` | pass | pass | 1028 | Second template: compliant wine photographed at an angle |
| `v2_title_case` | fail | fail | 918 | Second template: title-case warning prefix |
| `v2_wine_clean` | pass | pass | 1010 | Second template: compliant wine, serif, web address under the warning |
...
| `ai_bourbon` | fail | fail | 950 | AI-generated bourbon label; the model printed 'alcoholic alcoholic' in the warning |
| `ai_gin_arched` | pass | flag ⚠ | 3036 | AI-generated gin label, brand set in an arch over heavy botanical line art |
| `ai_malt_pint` | pass | pass | 4899 | AI-generated ale label, ornamental brand lettering, net contents '1 PINT 6 FL OZ' |
| `ai_no_warning` | fail | fail | 734 | AI-generated rye label with no government warning at all |
| `ai_photo_bar` | fail | flag ⚠ | 7047 | AI-generated phone photo of a bottle on a bar; small label, and the model garbled the warning |
| `ai_photo_compliant` | pass | flag ⚠ | 4140 | AI-generated close-up phone photo of a compliant bourbon label on a curved bottle |
| `ai_rum_photo_glare` | fail | flag ⚠ | 4378 | AI-generated phone photo of an imported rum with a glare streak; the model garbled the warning |
| `ai_scotch_import` | pass | flag ⚠ | 4794 | AI-generated Scotch import, alcohol and volume on one line, age statement under the class |
| `ai_tequila_import` | pass | flag ⚠ | 1488 | AI-generated tequila import, '100% Blue Agave Tequila' class line, folk-art border |
| `ai_title_case` | fail | fail | 1103 | AI-generated bourbon label with the warning heading in title case |
| `ai_vodka_import` | pass | pass | 2934 | AI-generated import: light type on a dark label, the warning hyphenates 'ma-chinery' across lines |
| `ai_wine` | pass | pass | 1106 | AI-generated wine label, brand only a little larger than the varietal, one-line bottler statement |
